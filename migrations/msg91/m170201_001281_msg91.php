...
class m170201_001281_msg91 extends \cmsgears\core\common\base\Migration {
	...
	private function insertSmsConfig() {
		...
		$this->insert( $this->prefix . 'core_form', [
			...
			'name' => 'Config SMS', 'slug' => 'config-sms-msg91',
		...
		$config = Form::findBySlugType( 'config-sms-msg91', CoreGlobal::TYPE_SYSTEM );
	...
	private function insertDefaultConfig() {
		...
		$metas = [
			[ $this->site->id, 'active', 'Active', 'sms-msg91', 1, 'flag', '1', NULL ],
			[ $this->site->id, 'msg91_auth', 'MSG91 Auth', 'sms-msg91', 1, 'text', NULL, NULL ],
		];
